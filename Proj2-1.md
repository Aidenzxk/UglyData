...
![](Rplot2.jpeg.png)
This graph shows the annual population increases averaged for each state, meaning each state's population growth or decline is linear. It is also split into 9 different graphs for easier viewing of each individual state. Plots 1, 4, 7, and 8 all show significant growth in the outlier state(s). 
